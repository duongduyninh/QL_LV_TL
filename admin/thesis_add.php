...
if(isset($_POST['submit'])){
    ...
    // $insert = "";
    $handle_insert = mysqli_query($mysqli, "INSERT INTO topic(topic_name, topic_file, topic_description, topic_detail, topic_type, topic_date_add, topic_date_updata, topic_code, faculty_id, user_id) VALUES ('$name', '$file', '$description', '$detail', '2', '$date', '$date', '$code', '$faculty_input', '$user')");
    header("location: ./thesis_index.php");
}
