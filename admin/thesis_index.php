...
$sql = mysqli_query($mysqli, "SELECT * FROM topic WHERE topic_type = 2");
?>
                ...
                <div class="row">
                            <div class="col-sm-12 col-md-1" >
                                <div class="ibox-head" style="width: 123px;">
                                    <div class="ibox-title" style="">TIỂU LUẬN</div>
                            ...
                            <div class="col-sm-12 col-md-2" style="margin-left: 30px;">
                                ...
                                <button  onclick="location.href='thesis_add.php'" class="btn btn-info" name="add">ADD</button>  
                                </div>
                            </div>
                        </div>
                    <div class="ibox-body">
